  ...
  try {
    ...
    try {
      ...
      if (workerExisting.length > 0) {
        ...
        console.log('   ✅ Care Worker user already exists (ID: ' + careWorkerId + ')');
      } else {
        ...
        console.log('   ✅ Care Worker user created (ID: ' + careWorkerId + ')');
      }
      ...
      if (profileExisting.length > 0) {
        ...
        console.log('   ✅ Care Worker profile updated');
      } else {
        await connection.execute(
